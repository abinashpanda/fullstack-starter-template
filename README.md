...
Fullstack starter kit for building web applications with [React](https://reactjs.org/), [Typescript](https://www.typescriptlang.org/) and [NestJS](https://nestjs.com/).
...
- [`typegoose`](https://typegoose.github.io/typegoose/) - Mongoose with Typescript
- [`nestjs-typegoose`](https://www.npmjs.com/package/nestjs-typegoose) - Injects typegoose models for nest components and controllers.
...
The frontend client `apps/client` is scafolled using [`vite`](https://vitejs.dev/). The codebase is divided into multiple folders
